    ...
    <div class="col-6 card shadow p-3">
        ...
        <form action="/data_pengguna/tambah/konfirmasi" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_lengkap" id="" aria-describedby="helpId" value="{{ old('nama_lengkap') }}" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_pengguna" id="" aria-describedby="helpId" value="{{ old('nama_pengguna') }}" autocomplete="off">
