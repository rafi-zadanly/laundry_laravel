    ...
    <div class="col-6 card shadow p-3">
        ...
        <form action="/data_pengguna/ubah/konfirmasi" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="id" aria-describedby="helpId" value="{{ $pengguna->id }}" readonly>
            </div>
            <div class="form-group">
                <label for="">Nama Lengkap<span class="required-input">*</span></label>
                <input type="text" class="form-control @error('nama_lengkap') is-invalid @enderror" name="nama_lengkap" id="" aria-describedby="helpId" value="{{ old('nama_lengkap') == '' ? $pengguna->nama_lengkap : old('nama_lengkap') }}" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control @error('nama_pengguna') is-invalid @enderror" name="nama_pengguna" id="" aria-describedby="helpId" value="{{ old('nama_pengguna') == '' ? $pengguna->nama_pengguna : old('nama_pengguna') }}" autocomplete="off">
            ...
            <div class="form-group">
                ...
                <select name="status_pengguna" id="" class="form-control @error('status_pengguna') is-invalid @enderror">
                    ...
                    <option value="admin" {{ $pengguna->status == 'admin' ? 'selected' : '' }}>Admin</option>
                    <option value="kasir" {{ $pengguna->status == 'kasir' ? 'selected' : '' }}>Kasir</option>
                </select>
